...
import org.example.infrastructure.specification.SpecificationBuilder;
import org.example.infrastructure.specification.SpecificationProviderManager;
import org.example.infrastructure.specification.field.TaskSpecificationKeys;
...
public class SpecificationBuilderImpl implements SpecificationBuilder<Task> {
    ...
    public Specification<Task> build(TaskSearchParameterDto searchParametersDto) {
        ...
        if (searchParametersDto.title() != null && searchParametersDto.title().length > 0) {
            specification =
                    specification.and(
                            taskSpecificationProviderManager
