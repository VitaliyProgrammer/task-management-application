...
public class UserController {
    ...
    public UserProfileResponseDto updateUserProfile(
            Authentication authentication, @RequestBody @Valid UserPutProfileRequestDto request) {
    ...
    public UserProfileResponseDto patchUserProfile(
            Authentication authentication, @RequestBody UserPatchProfileRequestDto request) {
