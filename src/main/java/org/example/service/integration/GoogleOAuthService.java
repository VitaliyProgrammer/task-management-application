...
import org.example.configuration.google.GoogleCredentialsProvider;
import org.example.configuration.properties.GoogleCalendarProperties;
import org.example.entity.GoogleOAuthState;
import org.example.entity.User;
import org.example.repository.GoogleOAuthStateRepository;
...
public class GoogleOAuthService {
    ...
    public String getAuthorizationUrl(String userEmail) {
        try {
            ...
            googleOAuthStateRepository.save(
                    new GoogleOAuthState(state, user,
            ...
            AuthorizationCodeRequestUrl authorization = flow.newAuthorizationUrl()
    ...
    public void exchangeCodeForRefreshToken(String code, String state) {
        ...
        try {
            GoogleOAuthState googleOAuthState = googleOAuthStateRepository.findById(state)
